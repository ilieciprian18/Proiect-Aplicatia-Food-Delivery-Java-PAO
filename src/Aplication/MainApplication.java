...
public class MainApplication {
    public static void main(String[] args) {
       ...
       // UseriAplicatie.addUser("Rebecca","Stamp","rebeccastamp@gmail.com","072260567", Gender.FEMALE, DateOfBirth(10,10,10),"rebeccastamp");
        ...
        RestauranteAplicatie.addRestaurant("Mcdonald's","Bucuresti",meniuMC);
       ...
       // RestauranteAplicatie.CautaRestaurant("Prestij");
        ...
        System.out.println(" 1:Afisare Date de nastere utilizatori");
        ...
        while( choice !=0)
        {
            ...
            if(choice == 3)
            {
                ...
                else UseriAplicatie.addUser(tempNume,tempPrenume,tempEmail,tempTelefon,Gender.MALE,DateAplicatie.lastElement(),tempUsername);
            ...
            if(choice ==5)
            {
                ...
                else LivratoriAplicatie.addLivrator(tempNume,tempPrenume,tempEmail,tempTelefon,Gender.MALE,birthdayDay,birthdayMonth,birthdayYear,tempUsername,MasiniAplicatie.lastElement());
